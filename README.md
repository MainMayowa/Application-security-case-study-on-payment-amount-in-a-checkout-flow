...
## A business logic vulnerability discovered during manual testing of a checkout flow that allowed manipulation of the payment amount sent to the payment gateway.
...
### Intercepted Payment Request
![Modified Payment Request](payment-request.png)
...
## Ethical Note
Testing described in this case study was performed in a controlled environment for educational and security research purposes. Sensitive details about the affected application have been intentionally omitted.
